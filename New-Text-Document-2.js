...
var posLines = [];
var colors = []; // màu
var colorsLines = []; // màu của viền
var vertexColors = []; // array chứa các màu
var distance = [0, 0, 0];
var uDistance;
var theta = [0, 0, 0]; // góc quay
var uTheta;
var scale = [1, 1, 1]; // phóng to thu nhỏ
var uScale;
// 0: x; 1: y; 2: z
var axis_rotate; // 
var program;
...
function DrawLines(a, b) { // vẽ
    ...
    colorsLines.push(vertexColors[2]);
    colorsLines.push(vertexColors[2]);
}
